...
public abstract class ListBasedBuilder<T, E extends AbstractValuedElement<T, E>, S extends ListBasedBuilder<T, E, S>> extends ValuedElementBuilder<T, E, S> {
    ...
    protected ListBasedBuilder(Text elementName, T value, List<T> values, Function<T, Text> textifier) {
