...
public abstract class ValuedElementBuilder<T, E extends AbstractValuedElement<T, E>, S extends ValuedElementBuilder<T, E, S>> extends BaseElementBuilder<T, E, S> {
